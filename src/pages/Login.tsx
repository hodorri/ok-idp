          ...
          <CardContent className="pt-6">
            <Tabs defaultValue="login">
              ...
              <TabsContent value="login" className="space-y-4">
                ...
                <Button className="w-full h-11 bg-accent text-accent-foreground hover:bg-accent/90 font-medium shadow-sm mt-2" onClick={handleLogin}>로그인</Button>
              </TabsContent>
              <TabsContent value="signup" className="space-y-4">
                ...
                <Button className="w-full h-11 bg-accent text-accent-foreground hover:bg-accent/90 font-medium shadow-sm mt-2" onClick={handleSignup}>회원가입</Button>
              </TabsContent>
            </Tabs>
          </CardContent>
        </Card>
